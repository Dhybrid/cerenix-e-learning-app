...
//   // UPDATE THE _loadInformationItems() METHOD IN YOUR FLUTTER CODE
...
//             print('📊 Server says count: ${responseData['count']}');
//             print('📊 We loaded: ${loadedItems.length}');
//           }
//         }
...
//         print('✅ Successfully loaded ${loadedItems.length} items');

//         // Print details of each item
//         for (var item in loadedItems) {
//           print('📄 Item: ${item.title}');
//           print('   - ID: ${item.id}');
//           print('   - Type: ${item.isGeneral}');
//           print('   - Category: ${item.category}');
//           print('   - Targeted: ${item.isTargeted}');
//           print('   - Activation Required: ${item.requiresActivation}');
//           print('   - Universities: ${item.universities}');
//           print('   - Faculties: ${item.faculties}');
//           print('---');
//         }
...
//         .where((item) => item.requiresActivation)
//         .length;
...
//     final requiresActivation = item.requiresActivation;
...
//     return content.replaceAllMapped(RegExp(r'src="(/[^"]*)"'), (Match match) {
...
//   @override
//   Widget build(BuildContext context) {
//     final requiresActivation = widget.infoItem.requiresActivation;

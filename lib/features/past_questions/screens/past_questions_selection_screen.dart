  ...
  Future<void> _loadOfflineSessions() async {
    try {
      ...
      for (var courseId in downloadedCourseIds) {
        ...
        // Read from past_questions
        final pastQuestions = courseData['past_questions'];
        if (pastQuestions == null) continue;

        for (var tq in pastQuestions as List) {
          ...
          if (sessionData is Map) {
            ...
            if (id != null && name != null && !sessionSet.containsKey(id)) {
              sessionSet[id] = PastQuestionSession(
                id: id,
                name: name,
                isActive: true,
              );
  ...
  Future<void> _loadTopicsFromOfflineCourse(String courseId) async {
    ...
    try {
      ...
      if (pastQuestions != null) {
        for (var q in pastQuestions as List) {
                            ...
                            children: [
                              ...
                              Text(
                                _hasOfflineCourses
                                    ...
                                    : 'Please download courses when online to access past questions.',
                                style: TextStyle(
                                  fontSize: 13,
